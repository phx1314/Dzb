...
import com.ndtlg.dzb.ada.AdaBjry;
...
public class FrgBjry extends BaseFrg {
    ...
    protected void create(Bundle savedInstanceState) {
        setContentView(R.layout.frg_bjry);
        initView();
        loaddata();
    }
    ...
    public void loaddata() {
        ...
        mAbPullListView.setAdapter(new AdaBjry(getContext(), new ArrayList()));
        mAbPullListView.setPageSize(16);
        mAbPullListView.setGetApiLoadParams(xcmClassStyleList + 2);
        mAbPullListView.setAbOnListViewListener(new AbOnListViewListener() {
            ...
            public MAdapter onSuccess(String methodName, String content) {
                ...
                return new AdaBjry(getContext(), data);
            }
        });
    }
