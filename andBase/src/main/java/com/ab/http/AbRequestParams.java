...
//                Charset.forName("UTF-8"));
        multiPart = new CustomMultipartEntity(
                new CustomMultipartEntity.ProgressListener() {
                    @Override
                    public void transferred(long num) {
//                        Log.i("进度", (num * 100 / multiPart.getContentLength()) + "");
                        Frame.HANDLES.sentAll("FrgFujianListNew,FrgGcwjList", 220, num * 100 / multiPart.getContentLength());
                    }
                }, HttpMultipartMode.STRICT, boundary,
                Charset.forName("UTF-8"));
    }
