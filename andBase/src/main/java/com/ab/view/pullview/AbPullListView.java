...
public class AbPullListView extends BaseListView implements OnScrollListener {
    ...
    public String PageSize_key = "limit";
    public Handler mHandler = new Handler();
    public Runnable runnable;
    public Object mBeanListBase;
...
//                            mListViewListener.onRefresh();
    ...
    public void loadData(boolean isRefreash) {
        if (type.equalsIgnoreCase("POST")) {
            ...
            loadUrlGet(method + "/" + startpage + "/" + PageSize, method, isRefreash, mparams);
        } else if (type.equalsIgnoreCase("GET_NO")) {
            loadUrlGet(method, method, isRefreash, mparams);
        } else {
...
//        mBeanListBase.endpage = endpage + "";
    ...
    public void setGET_NOApiLoadParams(String method, Object... mparams) {
        this.method = method;
        this.type = "GET_NO";
        this.mparams = mparams;
        pullLoad();
    ...
    public void setJsonApiLoadParams(String method, Object mBeanListBase) {
        this.method = method;
        this.type = "JSON";
